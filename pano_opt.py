...
def optimize_cor_id(cor_id, scoreedg, scorecor, num_iters=100, verbose=False):
    ...
    print('Before Pano Constraint: ',ceil_cor_id.shape)
    ...
    print('After Pano Constraint', ceil_cor_id.shape, ceil_cor_id_xy.shape,ceil_cor_id_xyz)
    ...
    print(pc, pc_vec, pc_theta, pc_height)
